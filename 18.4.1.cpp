//*******************************************ADARSH RAJ***K18PA*****11812708*********ROLL-5*************************************************
#include<iostream>
#include<iomanip>
#include<ctime>
#include<windows.h>
...
void car::for_car()
{
	...
	{
		case 1:
			{cout<<"You are to pay 26 INR for single journey\n"<<"THANK YOU!\n";
			...
			break;
		case 2:
		    {cout<<"you are to pay 38 INR for return journey\n"<<"THANK YOU!\n";
		    ifstream fin("collection.dat");
			fin>>collection;
			collection+=38;
			ofstream fout("collection.dat");
...
void bus::for_bus()
{
	...
	{
	case 1:
			{cout<<"You are to pay 90 for one way\n"<<"THANK YOU!\n";
			ifstream fin("collection.dat");
			fin>>collection;
			collection+=90;
			ofstream fout("collection.dat");
			...
			break;
		case 2:
		    {cout<<"you are to pay 134 for two way\n"<<"THANK YOU!\n";
		    ifstream fin("collection.dat");
			fin>>collection;
			collection+=134;
			ofstream fout("collection.dat");
...
void upto_3axle::for_upto_3axle() 
{
	xy1:
	ofstream fout;
	fout.open("upto_3axle",ios::app);
	fout<<vehicle_number<<"\n";
	fout.close();
	switch(temp)
	{
	    case 1:
			{cout<<"You are to pay 144 INR for single journey\n"<<"THANK YOU!\n";
			ifstream fin("collection.dat");
			fin>>collection;
			collection+=144;
			ofstream fout("collection.dat");
			...
			break;
		case 2:
		    {cout<<"you are to pay 216 INR for return journey\n"<<"THANK YOU!\n";
		    ifstream fin("collection.dat");
			fin>>collection;
			collection+=216;
			ofstream fout("collection.dat");
...
//	car a;
	...
	cout<<"1->Car/Jeep/Van"<<endl<<"2->Bus/Truck"<<endl<<"3->Upto 3 Axle"<<endl<<"4->4 to 6 Axle vehicle\n"<<"5->Government vehicle/Ambulance\n"<<endl;
   	 pix1:
	   car a;
	bus b;
    upto_3axle c;
		...
		case 1:
			{
				...
				count++;
			   	...
			   	fin.close();
			    cout<<"\nnumber of vehicles passed from lane 1: "<<count;
			}
		 ...
		 case 2:
			{
				...
				count++;
			   	...
			   	fin.close();
			    cout<<"\nNumber of vehicles passed from lane 2: "<<count;
			}
			 break;
			  case 3:
			{
				...
				count++;
			   	...
			   	fin.close();
			    cout<<"\nNumber of vehicles passed from lane 3: "<<count;
			}
			 break;
			  case 4:
			{
			  ...
			  case 5:
			{
				...
				count++;
			   	...
			   	fin.close();
			    cout<<"\nNumber of vehicles passed from lane 5: "<<count;
			}
			 break;
			  case 6:
			{
				...
				count++;
			   	...
			   	fin.close();
			    cout<<"\nNumber of vehicles passed from lane 6: "<<count;
			}
			 break;
			  case 7:
			{
			    ...
			    fin.close();
				cout<<"\nNumber of vehicles passed from lane 7: "<<count;
			}
			 break;
			  case 8:
			{
				...
				count++;
			   	...
			   	fin.close();
			    cout<<"\nNumber of vehicles passed from lane 8: "<<count;
			}
			 break;
			 default:
